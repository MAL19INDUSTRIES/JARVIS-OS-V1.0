            ...
            def _dispatch():
                try:
                    self.on_text_command(
                        ...
                        "and receive user-confirmed number-based calls, message drafts, and "
                        "supported app links. These actions are handled locally before model "
                        "dispatch. A native companion is under development but is not distributed, "
                        "so never instruct the user to open or install it. Never say that Phone "
                        "Link can do nothing, and never claim contact lookup, camera actions, "
                        "notifications, silent messaging, arbitrary screen automation, or "
                        "locked-screen network control.\n"
